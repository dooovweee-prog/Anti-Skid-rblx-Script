-- ╔══════════════════════════════════════════════════════════════════════════════╗
-- ║         MONITOR v14  --  ULTIMATE INDESTRUCTIBLE GUARDIAN + FULL DEFENSE    ║
-- ║   NPC AI · Deep Security · Integrity · Pathfinding · Server-Side Defense    ║
-- ╠══════════════════════════════════════════════════════════════════════════════╣
-- ║  Author  : Reset6437                                                        ║
-- ║  Version : 14.0.0                                                           ║
-- ║  Engine  : Roblox Server Script  (RunContext = Legacy)                      ║
-- ║  PLACE   : Drop this Script directly inside Workspace                       ║
-- ╠══════════════════════════════════════════════════════════════════════════════╣
-- ║  OVERHAUL from v13:                                                         ║
-- ║  • All top-level locals consolidated into tables to fix the 200-register    ║
-- ║    Luau compiler limit.                                                     ║
-- ║  • Case-insensitive matching via helper (no duplicate lists).               ║
-- ║  • 200+ new backdoor/exploit/hub signatures added.                          ║
-- ║  • Every section broken into sub-scope functions.                           ║
-- ║  • PivotTo used everywhere (no deprecated SetPrimaryPartCFrame).            ║
-- ║  • All LoadAnimation calls wrapped in pcall.                                ║
-- ║  • Model parented before LoadAnimation.                                     ║
-- ╚══════════════════════════════════════════════════════════════════════════════╝
